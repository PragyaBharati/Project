...
namespace WebApplication1.Models
{
    public partial class LabourZillaZoneContext : DbContext
    {
        ...
        public virtual DbSet<AdminLabourZilla> AdminLabourZilla { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<AdminLabourZilla>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<Labour>(entity =>
            {
                ...
                entity.HasIndex(e => e.Lcontact)
                    .HasName("UQ__labour__C2CF25DE6225F857")
                    .IsUnique();
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                ...
                entity.HasIndex(e => e.Lcontact)
                    .HasName("UQ__Users__C2CF25DE58DACD15")
                    .IsUnique();
